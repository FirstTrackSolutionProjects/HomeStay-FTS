      ...
      <div className="bg-white shadow-lg rounded-2xl max-w-5xl w-full flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-1/2 p-6 md:p-10">
          ...
          <p className="text-gray-600 text-sm md:text-base mb-4">
            First Home Stay is a trusted platform that connects travelers with quality accommodations across India.
          ...
          <p className="text-gray-600 text-sm md:text-base mb-4">
            Founded with the vision of making travel more personal and accessible, First Home Stay partners with local hosts
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Discover a better way to travel—comfortable, affordable, and always welcoming. Choose First Home Stay for your
