  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="w-full h-64 bg-gray-200 rounded-xl flex items-center justify-center">
        <span className="text-gray-500">[Hotel Image Carousel Here]</span>
      </div>

      {/* Hotel Info */}
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold">Hotel Shanti Palace</h1>
        <div className="flex items-center space-x-2 text-yellow-500">
          <Star className="w-5 h-5 fill-yellow-500" />
          <span className="text-sm font-medium">4.3</span>
          <span className="text-gray-600">Paharganj, Delhi</span>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <p className="text-sm text-gray-700">
            Hotel Shanti Palace offers luxury and comfort in the heart of Delhi. Ideal for business
            and leisure travelers, the property provides top-notch service, elegant rooms, and
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="text-sm text-gray-700 space-y-2">
            <p><strong>Ravi K:</strong> "Great location and service. Highly recommend!"</p>
            <p><strong>Priya S:</strong> "Rooms were clean and comfortable. Good value for money."</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          <h2 className="text-lg font-semibold mb-2">What's Nearby</h2>
          <ul className="list-disc list-inside text-sm text-gray-700">
            <li>New Delhi Railway Station - 1.2 km</li>
            <li>Connaught Place - 2.5 km</li>
            <li>Red Fort - 3.1 km</li>
      ...
      <Card>
        <CardContent className="p-4 space-y-3">
          <div className="text-2xl font-bold">₹925 <span className="line-through text-gray-400 text-lg">₹5237</span> <span className="text-orange-600 text-sm">82% off</span></div>
          <p className="text-sm text-gray-600">+ taxes & fees: ₹195</p>

          <div className="grid grid-cols-2 gap-2 text-sm">
            <span>FIRSTHOTEL60 coupon applied</span>
            <span className="text-green-600">-₹2016</span>

            <span>HOTEL Money applied</span>
            <span className="text-green-600">-₹330</span>

            <span>HOTEL Rupee applied</span>
            <span className="text-green-600">-₹200</span>

            <span>Gold membership discount</span>
          ...
          <div className="pt-2 border-t">
            <div className="flex justify-between font-semibold">
              ...
              <span className="text-green-600">₹2546</span>
            </div>
          ...
          <Button className="w-full mt-2 bg-green-600 hover:bg-green-700">Continue to Book</Button>
        </CardContent>
      </Card>
    </div>
  );
