...
//       prev.map((room, i) =>
//         i === index
//           ? { ...room, guests: Math.max(1, room.guests + delta) }
//           : room
//       )
//     );
//   };
...
//             <span>{`${rooms.length} Room${rooms.length > 1 ? "s" : ""}, ${totalGuests} Guest${totalGuests > 1 ? "s" : ""}`}</span>
//           </div>
...
//                     <button
//                       onClick={() => updateGuestCount(index, -1)}
...
//               <div className="flex justify-between items-center border-t pt-2 mt-2 text-blue-600 font-medium">
//                 <button
//                   onClick={deleteRoom}
//                   className={`${
//                     rooms.length === 1 ? "text-gray-400 cursor-not-allowed" : ""
//                   }`}
